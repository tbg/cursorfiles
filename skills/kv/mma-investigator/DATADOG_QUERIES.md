...
Before using these, read the `datadog-foundation` skill at
`~/.cursor/skills/kv.datadog-foundation/SKILL.md` for guidance on Datadog MCP
tools vs pup CLI, Flex tier usage, and tool selection.
